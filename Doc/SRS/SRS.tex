...
\item [\refstepcounter{funreq} \frthefunreq:]  The application will display the budget the user inputs, on page
\item [\refstepcounter{funreq} \frthefunreq:]  The application will disply the current day's expense
...
\subsection{Maintainability and Support Requirements}
 [\refstepcounter{msreq} \msthemsreq:] If the application crashes, none of the data should be lost
...
[\refstepcounter{legreq} \legthelegreq:]   The application is suitable for all ages, but targets those who are old enough to go shopping on their own
